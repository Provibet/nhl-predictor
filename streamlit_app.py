...
# Define credentials here (update with actual usernames and passwords)
USER_CREDENTIALS = {
    "Xyno": "Inferno345!",  # Example credentials; replace these
}
...
if st.session_state.authenticated:
    ...
    st.write("You need to log in to access this app.")