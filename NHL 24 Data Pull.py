...
# Step 1: Define the URL to download the CSV file
csv_url = 'https://moneypuck.com/moneypuck/playerData/seasonSummary/2024/regular/teams.csv'
...
# Example: Team name mapping (Adjust this based on your dataset's structure)
team_name_mapping = {
    'ANA': 'Anaheim Ducks',
    'BOS': 'Boston Bruins',
    'BUF': 'Buffalo Sabres',
...
# Step 6: Insert the new data into the PostgreSQL table with the name 'nhl24_matchups_with_situations'
table_name = 'nhl24_matchups_with_situations'
...
print(f"Data for the current season successfully inserted into {table_name}.")
